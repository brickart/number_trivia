...
import 'package:number_trivia/features/number_trivia/domain/usecases/get_random_number_trivia.usecase.dart';
...
void main() {
  ...
  test('initialState should be Empty', () {
    // assert
    expect(block.initialState, equals(Empty()));
  });

  group('GetTriviaForConcreteNumber', () {
    final tNumberString = '1';
    final tNumberParsed = 1;
    final tNumberTrivia = NumberTrivia(number: 1, text: 'test terivia');
    ...
    test(
      ...
      () async {
        ...
        // act
        block.dispatch(GetTriviaForConcreteNumber(tNumberString));
    ...
    test(
      ...
      () async {
        ...
        when(mockGetRandomNumberTrivia(any))
            .thenAnswer((_) async => Right(tNumberTrivia));
        // act
        block.dispatch(GetTriviaForRandomNumber());
